...
Mobi.autoFixGWebTop = function (a) {
    var j = Mobi.topTipMarquee(), d = Mobi.getPreviewObject("g_web"), c = Mobi.getPreviewObject("webTop"), h = Mobi.getPreviewObject("webBodyBackground"), f = Mobi.getPreviewObject("webHeaderBox");
    f.style.top = "";
    c.style.top = "";
    if (a !== 2 && a !== 7 && a !== 8) {
    ...
    if (a == 7) {
        var b = jm("#webHeader"), e = Mobi.getPreviewObject("navbar");
        if (j > 0) {
            e.style.top = j + "px"
        }
    ...
    f.style.top = j + "px";
    c.style.top = j + "px";
    d.style.paddingTop = (f.offsetHeight + j) + "px"
};
Mobi.topTipMarquee = function () {
    ...
    var a = Mobi.getPreviewObject("mobiTipsMarquee"), h = Mobi.getPreviewObject("webTips").offsetHeight;
...
Mobi.ing = function (p, q) {
    ...
    var o = "";
    if (q == "" || q == null || q == 0) {
        o = "<div class='icon-errorTigs'></div>"
    } else {
        if (q == 1) {
            o = "<div class='icon-succeedTigs'></div>"
        } else {
            if (q == -1) {
                o = ""
            }
    ...
    var j = "";
    if (k.indexOf("2052") >= 0) {
        j = parseFloat(p.length);
        if (j > 13 && j < 39) {
            j = 15;
            e = p.substring(0, 13) + "<br>" + p.substring(13)
        } else {
            if (j > 39) {
                j = 15;
                e = p.substring(0, 13) + "<br>" + p.substring(13, 39) + "<br>" + p.substring(39)
            }
        }
    } else {
        j = parseFloat(p.length) / 2;
        if (j > 15) {
            ...
            if (p.charAt(30) != "" && j < 50) {
                ...
                e = p.substring(0, h) + "<br>" + p.substring(h)
            } else {
                if (j > 50) {
...
Mobi.topContentFixedAutoHidden = function (b) {
    if (b == 0 || b == 2) {
        var e = Mobi.getPreviewObject("webHeaderBox"), c = e.style.top, f = document.querySelector("#webTips") ? true : false, h = {}, d = Mobi.getPreviewObject("g_web"), a = d.style.top;
...
Mobi.onlineServiceInputWord = function () {
    ...
    var f = document.querySelectorAll("input[type='text']"), e = document.querySelectorAll("textArea"), d = [], a = document.getElementById("webCustomerServiceBox");
    if (!a) {
        return
    }
...
Mobi.switchJump = function () {
    ...
    jm.each(a, function (c, d) {
        ...
        if (b.substring(0, 10) == "javascript") {
            ...
            d.setAttribute("onclick", b.substring(11) + "return false;")
        } else {
...
Mobi.prompt = function (l) {
    ...
    var a = Fai.top.document.body.clientHeight;
    var j = "<div id='mobiPrompt' class='mobiPrompt'></div>", h = "<div id='mobiPrompt_Bg' class='mobiPrompt_Bg'></div>";
    jm(j).appendTo("body");
    jm(h).appendTo("body");
    var d = jm("#mobiPrompt"), k = jm("#mobiPrompt_Bg");
    var e = [];
...
Mobi.initWebPage = function (f) {
    var r = f.triggerId, u = f.panelId, o = f.pageHtml, k = f.pageHead, b = f.pageBg || false, a = f.returnSeltFun || false, e = f.closeWebPage, p = f.direction || "right", j = f.callback;
    var d = "";
    if (!r) {
        return
    }
    ...
    if (p === "left") {
        ...
        if (p === "top") {
            ...
            if (p === "bottom") {
                n = "webPagePanelBottom"
            }
        }
    }
    var s = "";
    if (b) {
        s = "<div class='webPagePanelBg' style='z-index:999'></div>"
    }
    var d = 0;
    var c = 0;
    jm("#" + r).bind("click", function (v) {
        q();
        if (!l) {
            j && j();
            l = true
    ...
    var q = function () {
        if (h.length === 0) {
            jm("#g_web").append("<div id='webPagePanel" + r + "' class='webPagePanel' style='z-index:1000'>" + s + "</div>");
            h = jm("#webPagePanel" + r);
            if (o) {
                h.append(o);
                t = jm(o);
            ...
            t.show();
            setTimeout(function () {
                t.addClass("webPagePanelShow")
            });
            if (b) {
                Mobi.bindTouchAndClickEvent(jm("#webPagePanel" + r + " .webPagePanelBg"), function (A) {
            ...
            for (var y = 0; y < x.length; y++) {
                var z = x[y].trim();
                Mobi.bindTouchAndClickEvent(jm(z), function (A) {
                    t.removeClass("webPagePanelShow");
                    jm("#g_body").css({overflow: "", height: "", top: ""});
                    jm("html").css({overflow: "",});
                    jm("#g_web").removeClass("gwNoScroll");
                    jm("#webPagePanel" + r).css("z-index", "-1");
                    window.scrollTo(0, c);
                    if (r == "userCommentId" || r == "postComment") {
            ...
            Mobi.bindTransitionEnd(t, function () {
                if (!t.hasClass("webPagePanelShow")) {
                    h.hide()
                }
            })
        } else {
...
Mobi.initProductGroup = function (c, j, e) {
    ...
    k.find(".firstGroup .firstGroupItem").on("click.productNewGroup", function () {
        ...
        var s = jm(this), u = jm(s).attr("data-id"), t = jm("#sed_" + u);
    ...
    function d(s) {
        var r = parseInt(jm(s).attr("data-w")), t = parseInt(jm(s).attr("data-h"));
        if (r >= t) {
            jm(s).css("width", "2.8rem").css("height", "auto").css("vertical-align", "middle")
        } else {
            if (t > r) {
                jm(s).css("width", "auto").css("height", "2.9rem").css("display", "block").css("margin", "0 auto")
            }
        }
    }
};
    ...
    function h() {
        ...
        f(j.targets).find(".quick_in").unbind("click.quickIn").bind("click.quickIn", function (n) {
            ...
            function l(o) {
                var p = f.parseJSON(o);
                if (p) {
                    j.popupWindowOption.closeFunc(k, p.data[0])
                }
            }
        });
...
Mobi.showNavItemContainer = function () {
    ...
    var v = Mobi.getPreviewObject("navbarList"), b = Mobi.getPreviewObject("navbar"), e = v, t = parseInt(jm(b).width()), l = 0, k = b.querySelectorAll(".navItem"), u = b.querySelectorAll(".itemSep");
    ...
    if (l > t) {
        ...
        if (jm.os.supportsTouch) {
            var c = new iScroll(b, {
                ...
                remarkNavLeftRight: z
            });
            z(A, c);
            function z(j, p) {
                var C = p.wrapper.querySelector(".navLeft") ? p.wrapper.querySelector(".navLeft") : p.wrapper.querySelector(".navTouchLeft"), D = p.wrapper.querySelector(".navRight") ? p.wrapper.querySelector(".navRight") : p.wrapper.querySelector(".navTouchRight");
            ...
            var r = jm(b).find(".navLeft"), B = jm(b).find(".navRight"), a = jm(b).find(".navbarList"), q = null;
            if (A < 0) {
                r.css("display", "block");
                jm(e).css("left", A + "px")
            }
            ...
            jm(b).bind("swipeLeft", function (j) {
            }).bind("swipeRight", function (j) {
            });
            function n(C, p) {
                jm(C).unbind(p);
                if (w >= s.length) {
                ...
                setTimeout(function () {
                    if ((Math.abs(e.offsetLeft) + t) < l) {
                        B.css("display", "block")
                    }
                    if (e.offsetLeft >= -1) {
                        r.css("display", "none")
                    }
                    jm(C).bind(p, function () {
                        n(this, p)
                    })
                }, 600)
            }
...
Mobi.msgBoardAddMsg = function (n) {
    ...
    jm("input.msg_isMust").each(function () {
        ...
        var o = jm(this).val();
        if (o == "" || o == null) {
            b.html(jm.format(LS.msgBoardInputIsEmpty, jm.encodeHtml(q)));
            Mobi.getPreviewObject(p).focus();
            e = 1;
            return false
        }
        if (p == "reqPhone" && !jm.isPhone(o)) {
            b.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(q)));
            Mobi.getPreviewObject(p).focus();
            e = 1;
            return false
        }
        if (p == "reqEmail" && !jm.isEmail(o)) {
            b.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(q)));
            Mobi.getPreviewObject(p).focus();
            e = 1;
            return false
    ...
    jm("input.msg_ipt").each(function () {
        ...
        if (o.length > q) {
            b.html(jm.format(LS.msgBoardInputMaxLength, jm.encodeHtml(r), q));
            d = 1;
            return false
        }
        if (p == "reqPhone" && o.length && !jm.isPhone(o)) {
            b.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(r)));
            Mobi.getPreviewObject(p).focus();
            d = 1;
            return false
        }
        if (p == "reqEmail" && o.length && !jm.isEmail(o)) {
            b.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(r)));
            Mobi.getPreviewObject(p).focus();
            d = 1;
            return false
...
Mobi.noticeLeftRightMarquee = function (e, B) {
    ...
    var o = A.id, x = Mobi.getPreviewObject("noticeMarquee" + o), h = x.offsetHeight, f = x.offsetWidth, r = 0, a = x.querySelectorAll(".noticeMarqueeRow>span");
    for (var t = 0; t < a.length; t++) {
        r += a[t].offsetWidth
    }
    var c = Mobi.getPreviewObject("noticeContainer" + o), d = c.offsetWidth, n = (r > d) ? r : d;
    var F = A.direction, E = 0, l = "left", u = A.speed, D = (A.loop != "infinite" || A.loop <= 0) ? 1 : A.loop, p = false, G = A.isScrolling, z = A.noticeType, C = 20, w = Mobi.createElementByHtml("<div id='noticeMarqueeCopy" + o + "' class='noticeMarquee' style='overflow:hidden;width:" + n + "px;' ></div>");
...
Mobi.noticeMarqueeUpDown = function (e) {
    ...
    for (var f = 0; f < noticeScrollbarsLis.length; f++) {
        h[f] = noticeScrollbarsLis[f].offsetTop
    }
    if (b.direction == "top") {
        h.reverse()
    }
    ...
    if (p.length > 0) {
        jm.each(p, function (C, x) {
            ...
            if (D == 0) {
                ...
                if (G && w == "") {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(r)));
                    b = false;
                    return false
                }
                if (w.length > k) {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(r), k));
                    b = false;
                    return false
                }
                A.val = w
                ...
                if (D == 1) {
                    ...
                    if (u.length > c) {
                        Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(r), c));
                        b = false;
                        return false
                    }
                    A.val = u
                    ...
                    if (D == 2) {
                        ...
                        if (G && t.length == 0) {
                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(r)));
                            b = false;
                            return false
                        }
                        if (t.length > 0) {
                        ...
                        if (D == 3) {
                            ...
                            if (D == 4) {
                                var E = document.getElementById("M" + a + "F" + q + "siteFormSelect" + v), z = E.options[E.selectedIndex].value;
                                if (G && (z.length == 0 || z == "none")) {
                                    Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(r)));
                                    b = false;
                                    return false
                                }
                                ...
                                if (D == 5) {
                                    ...
                                    if (D == 6) {
                                        ...
                                        if (D == 7) {
                                            ...
                                            var y = {};
                                            if (G && s.attr("_tmpFileId") == "") {
                                                Mobi.ing("请选择文件上传");
                                                b = false;
                                                return false
                                            }
                                            if (s.attr("_tmpFileId") == "") {
                                                A.val = ""
                                            } else {
                                                A.val = s.attr("_fileId");
...
Mobi.siteFormFileUploadHtml = function (r, d, a, n, q, p, h, b, c, k, o) {
    var l = {
        ...
        buttonText: o,
        getFileSizeUrl: "/" + k + "/ajax/advanceUpload.jsp?cmd=_getUploadSize",
        uploader: "/" + k + "/ajax/advanceUpload.jsp?cmd=_mobiupload",
        onUploadStart: function (s) {
    ...
    e.onload = function () {
        ...
        f.appendChild(s);
        s.onload = function () {
            upload = jm("#uploadButton" + d + r).uploadify(l)
        }
    };
...
Mobi.fixIphoneStyle = function (c, b) {
    ...
    if (a.indexOf("iPhone") > -1) {
        jm("#module" + b + "").find(".F" + c + "siteFormItemShowVal").find("textArea").css({width: "90%"});
...
Mobi.memberLogin = function (a, l, b) {
    var k = jm("#user").val();
    var f = jm("#password").val();
    var e = (jm(".loginCaptchaCtrl").css("display") != "none");
    var h = jm("#loginCaptcha").val();
    if (l != null && b != null) {
        jm.cookie("_moduleid", l);
        jm.cookie("_fileid", b)
    }
    if (k == null || k == "") {
...
Mobi.wbWinListener = function (e, d, f, b, c, a) {
...
Mobi.qqWinListener = function (e, d, f, b, a, c) {

};
Mobi.memberOtherLoginAdd = function (a, e, j, d, b, h, f) {
    var c = "<div style='height:5rem;'>";
    if (f == 1) {
        c += "<div class='avator' style='height:2.5rem;width:2.5rem;margin-top:1rem;margin-left:6.2rem;border-radius:50%;background:url(" + j + ");background-size:2.5rem;'></div>"
    } else {
        c += "<div class='avator' style='height:1.2rem;width:1.2rem;margin-top:1rem;margin-left:6.6rem;border-radius:50%;background:url(" + j + ");background-size:1.2rem;'></div>"
    }
    c += "<div class='userName' style='margin-top:0.5rem;'>" + a + "</div>";
    c += "</div>";
    c += "<div class='desc' style='height:3rem;font-size:0.6rem;color:#666;'>";
    if (f == 1) {
        c += "<div class='firstLine' style='width:4.5rem;'>" + LS.memberOtherLgnQQUser + ":</div>"
    } else {
        c += "<div class='firstLine' style='width:5.8rem;'>" + LS.memberOtherLgnWBUser + ":</div>"
    }
    c += "<div class='secondLine' style='width:13rem;margin-top:0.5rem;'>" + LS.memberOtherLgnBindAcctMsg + "</div>";
    c += "</div>";
    c += "<div class='choose' style='font-size:0.6rem;color:#999;height:7rem;'>";
    c += "<div class='haveMember' style='width:3rem;'>" + LS.memberOtherLgnHaveAcct + "</div>";
    c += "<div class='bindNow g_button sendIcon' style='margin-bottom:1rem;' onclick='Mobi.bindNow(" + f + ', "' + e + "\");'>" + LS.memberOtherLgnBindNow + "</div>";
    c += "<div class='noMember' style='width:3rem;'>" + LS.memberOtherLgnNotAcct + "</div>";
    c += "<div class='signUp g_button sendIcon' id='signUp' >" + LS.memberOtherLgnSignUp + "</div>";
    c += "</div>";
    if (!jm("#bindAcct .loginContent").children().length) {
        jm("#bindAcct .loginContent").append(c)
    }
    jm("#mLogin").hide();
    jm("#bindAcct").show();
...
Mobi.bindNow = function (d, b) {
    ...
    a += "</div>";
    if (d == 1) {
        a += "<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:12rem;'>" + LS.memberOtherLgnQQMsg + "</div>"
    } else {
        a += "<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:13.5rem;'>" + LS.memberOtherLgnSinaMsg + "</div>"
    }
    a += "<div class='g_globalLine'>";
    ...
    if (!jm("#bindNow .loginContent").children().length) {
        jm("#bindNow .loginContent").append(a)
    }
    jm("#bindAcct").hide();
    jm("#bindNow").show();
...
Mobi.signUp = function (f, b, c, e, a, k) {
    var d = false;
    var l = "";
    var h = "";
    var j = "";
    l += "<div class='g_globalLine'>";
    l += "<input type='text' maxlength='50' id='memberSignupAcct' class='mustItem itemEdit userAddItem g_input' placeholder='" + LS.memberSignupRegisterAcctEmpty + LS.memberOtherLgnMust + "'><span class='icon-userIcon g_mainColor'></span>";
    l += "</div>";
    l += "<div class='g_globalLine'>";
    l += "<input type='password'  maxlength='20' id='memberSignupPwd' class='mustItem itemEdit icon-pswIcon userAddItem g_input' placeholder='" + LS.memberDialogPleaseEnterPwd + LS.memberOtherLgnMust + "'><span class='icon-pswIcon g_mainColor'></span>";
    l += "</div>";
    l += "<div class='g_globalLine'>";
    l += "<input type='password'  maxlength='20' id='memberSignupRepwd' class='mustItem itemEdit icon-pswIcon userAddItem g_input' placeholder='" + LS.memberDialogPleaseEnterPwd2 + LS.memberOtherLgnMust + "'><span class='icon-pswIcon g_mainColor'></span>";
    l += "</div>";
    jm.each(f, function (o, p) {
        if ("email" == p.fieldKey) {
            h = "icon-emailIcon g_mainColor"
        } else {
            if ("phone" == p.fieldKey) {
                h = "icon-phoneIcon g_mainColor"
            } else {
                if ("name" == p.fieldKey) {
                    h = "icon-nameIcon g_mainColor"
                } else {
                    h = "icon-customIcon g_mainColor";
                    j = "customIcon"
                }
            }
        }
        l += "<div class='g_globalLine'>";
        if (p.must) {
            l += "<input type='text' maxlength='50' id='" + p.fieldKey + "' name='" + p.name + "' class='mustItem isCheckUAI itemEdit userAddItem  g_input' maxlength='50' placeholder='" + LS.memberOtherLgnPleaseInput + p.name + LS.memberOtherLgnMust + "'><span class='" + h + "'></span>"
        } else {
            l += "<input type='text' maxlength='50' id='" + p.fieldKey + "' name='" + p.name + "' class='itemEdit userAddItem  g_input' maxlength='50' placeholder='" + LS.memberOtherLgnPleaseInput + p.name + "'><span class='" + h + "'></span>"
        }
        if (j != "") {
            l += "<span class='" + j + "'>" + p.name + "</span>"
        }
        l += "</div>"
    });
    if (b) {
        l += "<div class='g_globalLine'>";
        l += "<input type='text' class='itemEdit g_input userAddItem' id='memberSignupRemark' maxlength='200' placeholder='" + LS.memberOtherLgnRemark + "'><span class='icon-msgIcon g_mainColor'></span>";
        l += "</div>"
    }
    if (e == 1) {
        l += "<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:12rem;'>注册后，您的QQ帐号和会员帐号都可以登录</div>"
    } else {
        l += "<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:13.5rem;'>注册后，您的新浪微博帐号和会员帐号都可以登录</div>"
    }
    l += "<div class='signupSubmitCtrl g_globalLine'>";
    l += "<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.memberOtherLoginSubmit(" + e + ", " + d + ', "' + a + '", "' + k + "\")' value='" + LS.memberOtherLgnSignUp + "'/>";
    l += "</div>";
    if (!jm("#mSignUp .loginContent").children().length) {
        jm("#mSignUp .loginContent").append(l)
    }
    jm("#mSignUp").show();
    jm("#bindAcct").hide();
...
Mobi.memberOtherLoginSubmit = function (h, b, f, n) {
    var r = "";
    var u = {};
    if (h == 1) {
        u.qqOpenId = f;
    ...
    if (b) {
        ...
        jm(".userAddItem").each(function () {
            ...
            u[userAddItemID] = e;
            if (e.length > o) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemMaxLength, a, o));
...
Mobi.memberSignupSubmit = function (b) {
    var q = jm("#memberSignupAcct").val();
    if (q == null || q == "") {
        Mobi.ing(LS.memberSignupRegisterAcctEmpty);
        Mobi.getPreviewObject("memberSignupAcct").focus();
        return
    }
    var o = jm("#memberSignupPwd").val();
    if (o == null || o == "") {
        Mobi.ing(LS.memberSignupRegisterPwdEmpty);
        Mobi.getPreviewObject("memberSignupPwd").focus();
        return
    ...
    var j = jm("#memberSignupRepwd").val();
    if (o != j) {
        Mobi.ing(LS.memberSignupRegisterPwdNotMatch);
        Mobi.getPreviewObject("memberSignupRepwd").focus();
        return
    ...
    jm(".userAddItem").each(function () {
        ...
        d[userAddItemID] = l;
        if (l.length > f && s == "input") {
            Mobi.ing(jm.format(LS.memberSignupUserAddItemMaxLength, h, f));
            Mobi.getPreviewObject(userAddItemID).focus();
            t = 1;
            return false
        }
        if (userAddItemID == "email" && l.length > 0) {
            if (!jm.isEmail(l)) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, h));
                Mobi.getPreviewObject(userAddItemID).focus();
                k = 1;
                return false
            }
        }
        if (userAddItemID == "phone" && l.length > 0) {
            if (!jm.isPhone(l)) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, h));
                Mobi.getPreviewObject(userAddItemID).focus();
                k = 1;
    ...
    jm(".isCheckUAI").each(function () {
        ...
        if (l == null || l == "") {
            if (jm(this).is("input")) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemIsEmpty, h))
            } else {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemIsEmpty2, h))
            }
            Mobi.getPreviewObject(userAddItemID).focus();
            e = 1;
            return false
...
Mobi.getEmailCarriersAddress = function (a) {
    ...
    if (b === "qq.com" || b === "vip.qq.com" || b === "foxmail.com") {
        ...
        if (b === "163.com") {
            c.name = "163";
            c.addr = "/smart.mail.163.com";
            return c
        } else {
            if (b === "126.com") {
                c.name = "126";
                c.addr = "/smart.mail.126.com";
                return c
            } else {
                if (b === "sina.com" || b === "vip.sina.com") {
                    c.name = "sina";
                    c.addr = "/mail.sina.com.cn";
                    return c
                } else {
                    return -1
                }
...
Mobi.memberAddrInfoOpera = function (b, d, p) {
    var f = d, r = "", h = "", e = f.length, q = "", l = false;
    jm("#addrInfoList .addAddrInfo").click(function () {
        ...
        if (e < 6) {
            ...
            r = "add";
            q = "ajax/member_h.jsp?cmd=set&opera=" + r + "&id=" + b
        } else {
    ...
    jm("#addrInfoList .edit , #addrInfo .nameAndPhone , #addrInfo .address").click(function () {
        ...
        if (jm(this).attr("class") == "edit") {
            h = jm(this).parent().parent().attr("_item")
        } else {
            h = jm(this).parent().attr("_item")
        }
        r = "edit";
        ...
        var z = x.addr_info;
        if (z != null) {
            jm("#addrInfo_province").val(z.provinceCode);
    ...
    jm(".saveAddrInfo").click(function () {
        ...
        var A = "";
        var x = false;
        F.parent().find(".propItemValue").each(function () {
            M = jm(this).attr("_field");
            B = jm(this).val();
        ...
        if (H) {
            jm.ajax({
                type: "post", url: q, data: "info=" + jm.encodeUrl(jm.toJSON(y)), error: function () {
                    Mob;
                        ...
                        if (r == "edit") {
                            if (C) {
                                jm("#addrInfoList").find(".addrInfo").each(function () {
                                    ...
                                    if (jm(this).attr("_item") == h) {
                                        jm(this).find(".name").text(y.name);
                            ...
                            if (r == "add") {
                                var O = "";
                                if (C) {
                                    O = "<div class='addrInfo' _item='" + e + "'><div class='nameAndPhone'><span class='name'>" + y.name + "</span><span class='phone'>" + y.phone + "</span></div><div class='address'><span class='defaultAddr'>默认</span><span id='addr'>" + y.addr + "</span></div><div class='opera'><div class='edit'></div></div></div>";
                                    jm("#addrInfoList").find(".addrInfo").each(function () {
                                        if (jm(this).find(".defaultAddr").attr("style") != "display:none") {
                                            jm(this).find(".defaultAddr").hide();
                                            jm(this).find(".delete").show();
                                    ...
                                    O = "<div class='addrInfo' _item='" + e + "'><div class='nameAndPhone'><span class='name'>" + y.name + "</span><span class='phone'>" + y.phone + "</span></div><div class='address'><span class='defaultAddr' style='display:none'>默认</span><span id='addr'>" + y.addr + "</span></div><div class='opera'><div class='delete'></div><div class='edit'></div></div></div>"
                                }
    ...
    jm("#addrInfoList .delete").click(function () {
        ...
        var x = function (B, A) {
            jm.ajax({
                ...
                data: "cmd=set&opera=delete&id=" + B + "&_item=" + A,
                error: function () {
                ...
                success: function (C) {
                    ...
                    if (E.success) {
                        ...
                        var D = 0;
                        jm("#addrInfoList").find(".addrInfo").each(function () {
                            if (jm(this).attr("_item") == A) {
                                jm(this).remove()
                            } else {
                                jm(this).attr("_item", D);
                                D++
                            }
                        });
                        e--;
        ...
        var y = {
            textClass: "deleteOrder", content: "确定要删除该收货人信息吗？", callback: function () {
                x(b, h)
            }
        };
        Mobi.prompt(y)
    ...
    var o = LS.mallPleaseChoose, u = [], j, v, n, s, w, k, t;
    if (p == 2052 || p == 1028) {
        site_cityUtil.simpleProvinceName(t);
        t = site_cityUtil.getProvince()
    } else {
        site_cityUtil.simpleProvinceNameEn(t);
        t = site_cityUtil.getProvinceEn()
    }
    jm.each(t, function (x, y) {
        if (p == 2052 || p == 1028) {
            u.push("<option value='" + y.id + "'>" + site_cityUtil.simpleCityNameStr(y.name) + "</option>")
        } else {
            u.push("<option value='" + y.id + "'>" + site_cityUtil.simpleCityNameStrEn(y.name) + "</option>")
        }
    });
    jm("#addrInfo_province").html("").html("<option value='-1'>" + o + "</option>" + u.join("")).change(function (x) {
        ...
        n = [];
        if (p == 2052 || p == 1028) {
            v = site_cityUtil.getCities(j);
            site_cityUtil.simpleCityName(v)
        } else {
            v = site_cityUtil.getCitiesEn(j);
            site_cityUtil.simpleCityNameEn(v)
        }
        jm.each(v, function (y, z) {
            n.push("<option value='" + z.id + "' >" + z.name + "</option>")
        });
        jm("#addrInfo_city").html("").html("<option value='-1'>" + o + "</option>" + n.join("")).unbind().bind("change", function (y) {
            s = jm("#addrInfo_city").val();
            if (isNaN(s) || s <= 0) {
                jm("#addrInfo_county").html("").html("<option value='-1'>" + o + "</option>")
            }
            k = [];
            if (p == 2052 || p == 1028) {
                w = site_cityUtil.getCounty(s)
            } else {
                w = site_cityUtil.getCountyEn(s)
            }
            jm.each(w, function (z, A) {
                k.push("<option value='" + A.id + "' >" + A.name + "</option>")
            });
...
(function (f, b, e) {
    var h = b.prototype, r, j, a, p = [], q = 10, o;
    h.init = function () {
        j = this.pIdList, a = this.panel;
        r = this.mid;
        if (j.length == 0) {
            k();
            return
    ...
    function k() {
        if (j.length == 0) {
            a.find(".profileContent").html("<div class='noCollIcon'></div><div class='noCollTip'>" + LS.notCollect + "</div>")
        }
    }

    function c() {
        f.post("ajax/product_h.jsp", {mid: r, cmd: "updateCollections", ids: f.toJSON(j)}, function (u) {
            if (u.success) {
                j = u.list
            }
        }, "json")
    ...
    function d(u) {
        f.ajax({
            ...
            data: {cmd: "batchGetPd", ids: f.toJSON(u)},
            async: false,
            type: "POST",
            dataType: "json",
            success: function (v) {
    ...
    function l() {
        ...
        f.ajax({
            url: "ajax/member_h.jsp",
            data: {cmd: "set", id: r, info: f.toJSON(v), opera: "updataCollection"},
            async: false,
            type: "POST",
            dataType: "json",
            success: function (w) {
    ...
    function n(u, v) {
        ...
        f.each(v, function (x, y) {
            ...
            if (y.mallPrice != -1) {
                w.push('  <div class="pdPrice"><div class="mallPrice">￥ ' + y.mallPrice + "</div></div>")
            }
    ...
    function s() {
        console.log(a.find(".collectionList li img[_src]"));
        a.find(".collectionList li img[_src]").each(function () {
    ...
    function t() {
        Mobi.onTouchAndClickEvent(".cancelCollection", function (x) {
            var v = $(this);
            var w = {
                textClass: "deleteOrder", content: LS.sureCancelCollect, callback: function () {
...
(function (h, c, f) {
    var k = c.prototype;
    var n = h(".picArea .coverImg"), a = h(".picArea"), l = h("#headPic"), q, e, s, b, t, o, r, j;
    k.init = function () {
        this.initBind()
    };
    k.initBind = function () {
        ...
        h("#memberHeadPic").click(function () {
            var F = setInterval(function () {
                if (h("#headPic")[0].complete) {
                    ...
                    o = (q - l.height()) / 2;
                    r = (e - l.width()) / 2;
                    if (h.toJSON(E.headPicJson) == "{}" || E.headPicJson.thumbId == "") {
                        b = o;
                        t = r;
                        j = Number(l.width())
                    } else {
        ...
        h(".editHeadPicFooter .saveBtn").click(function () {
            ...
            if (G != null) {
                $.ajax({
                    ...
                    data: "oldImgId=" + I + "&mid=" + F + "&newImg=" + h.encodeUrl(G),
                    async: false,
                    error: function () {
            ...
            $.ajax({
                type: "post",
                async: false,
                url: "ajax/member_h.jsp?cmd=set&opera=setimg",
                data: "id=" + F + "&info=" + h.encodeUrl(h.toJSON(H)),
                error: function () {
                    Mobi.ing(LS.memberProfileError)
                },
                success: function (J) {
    ...
    function d() {
        if (j < 100) {
            ...
            if (j > Math.min(l[0].height, l[0].width)) {
                j = Math.min(l[0].height, l[0].width)
            }
        }
        if (b < o) {
            b = o
        ...
        if (b >= o && b <= o + l[0].height - j && t >= r && t <= r + l[0].width - j) {
            n.css({width: j + "px", height: j + "px", top: b + "px", left: t + "px"});
...
Mobi.initMemberUploadImg = function (d, e, l, n, j, k, o, c) {
    ...
    b.onload = function () {
        ...
        p.onload = function () {
            if (c == "true") {
                Mobi.mobiMemberUploadImgSWF("file_upload", d, e, 1, k)
            } else {
                Mobi.mobiMemberUploadImgHtml("file_upload", d, e, k)
            }
        }
    };
    var h = document.documentElement || document.body;
...
Mobi.mobiMemberUploadImgSWF = function (e, c, h, b, a) {
    ...
    var d = {
        ...
        view_progress: function (j, n, l, k) {
...
Mobi.mobiMemberUploadImgHtml = function (h, d, e, f) {
    ...
    var j = {
        ...
        isOrnotButton: true,
        buttonText: "",
        uploader: "/" + f + "/ajax/memberHeadImgUp_h.jsp?cmd=mobiUpload&_TOKEN=" + c,
        onUploadStart: function (l) {
            jm("#progressBody_ " + l.id).remove();
            jm("#progressWrap_" + l.id).remove()
        },
        onUploadSuccess: function (l, o) {
            ...
            if (n.success) {
                ...
                Mobi.ing(LS.mobiFormSubmitFileUploadFile + l.name + "   " + n.msg)
            }
        },
        onUploadError: function (l, n) {
            m("#progressWrap_" + l.id).remove();
...
Mobi.memberFdPwd = function (a, c) {
    ...
    jm.ajax({
        ...
        success: function (d) {
            ...
            if (d.success) {
                if (d.noMail) {
                    Mobi.ing(LS.memberDialogNoEmailMsg, true);
                    return
                }
                ...
                Mobi.sendMemberEmailCodeImgFix("#memEmailCode", a);
                Mobi.sendMemberEmailPwdCode(b)
            } else {
                if (d.notFound) {
...
Mobi.initModulePhotoList = function (v, e, c) {
    ...
    module = "module" + v;
    var k = document.getElementById(module), d = document.getElementById("webFooterBox"), w = document.createElement("div"), p = document.createElement("div"), h = document.createElement("div"), n = document.createElement("div");
...
Mobi.initScaleImage = function (h) {
    if (h) {
        var f = h.querySelectorAll("img"), d = h.clientWidth, a = 0;
        if (f) {
            for (var e = 0; e < f.length; e++) {
                var c = parseInt(f[e].getAttribute("vwidth") ? f[e].getAttribute("vwidth") : 1), b = parseInt(f[e].getAttribute("vheight") ? f[e].getAttribute("vheight") : 1), j = b / c;
                if (j === NaN) {
                    continue
                }
                f[e].style.width = d + "px";
                f[e].style.height = Math.floor(d * j) + "px";
                if (j > a) {
                    a = j
                }
            }
            if (d * a != 0) {
                h.style.height = Math.floor(d * a) + "px"
            }
        }
    }
};
Mobi.initPhotoImageSwipe = function (a) {
    ...
    b("#" + a).swipehandle(d, {
        isOpenNextAndPrevious: true, callback: function (j, e) {
            var h = e.querySelector("img"), f = h.getAttribute("lazysrc");
            if (!h.src) {
                h.src = f;
                h.onload = function () {
                }
...
Mobi.initModulePhotoSwipe = function (e) {
    ...
    var d = {
        imageScaleMethod: "fitNoUpscale", getImageCaption: function (f, h) {
            var k, j;
            k = f + "/" + h;
...
Mobi.initModulePhotoDetailSwipe = function (b, q, o) {
    ...
    var l = [];
    if (o) {
        l = document.querySelectorAll("#" + b + " .photoGroup-img")
    } else {
        l = document.querySelectorAll("#" + b + " img")
    }
    if (l.length < 1) {
        return
    }
    if (o) {
        var c = [];
        if (l[0].nodeName === "DIV") {
            l[0].src = l[0].getAttribute("datasrc") || ""
        }
        c.push(l[0]);
    ...
    var r = {
        ...
        uiDetailCallBack: function (t, x, s) {
            var u = this;
            jm(t).html("");
            var z = q[p.currentIndex], w = z.groupId, y = z.id, v = z.name;
            jm(s).html(v);
            jm(x).addClass(a.Carousel.CssClasses.itemLoading);
            jm.ajax({
                type: "post",
                url: "ajax/photo_h.jsp",
                data: "cmd=getInfo&id=" + jm.encodeUrl(y) + "&groupId=" + jm.encodeUrl(w),
                error: function () {
                    Mobi.ing(LS.systemError)
                },
                success: function (A) {
                    ...
                    if (D.length === 0) {
                        u.detailScroll && u.detailScroll.destroy();
                        u.detailScroll = null;
    ...
    }, n = null, e = null, k = null, h = null, a = window.Code.PhotoSwipe, p = a.attach(l, r);
        ...
        type: "get", url: "../ajax/getPhotoData_h.jsp?groupId=" + a + "&cmd=getPhotoData", success: function (q) {
            ...
            var p = {
                ...
                uiDetailCallBack: function (s, w, r) {
                    var t = this;
                    jm(s).html("");
                    var y = json[o.currentIndex], v = y.groupId, x = y.id, u = y.name;
                    jm(r).html(u);
            ...
            }, n = null, f = null, j = null, h = null, c = window.Code.PhotoSwipe, o = c.attach(l, p);
...
Mobi.initProductRestrict = function (limitAmount_mall, onlineMallMinAmount, onlineMallMaxAmount, productRestrictInfo) {
    if (limitAmount_mall) {
        var buyedCount = 0;
        ...
        if (onlineMallMinAmount > 1 && onlineMallMaxAmount != 0) {
            ...
            jm("#limitAmountDiv").text("( " + LS.minAmount + " : " + onlineMallMinAmount + " ; " + LS.maxAmount + " : " + allowAmount + " )");
            min = onlineMallMinAmount;
            max = allowAmount
        } else {
            if (onlineMallMinAmount == 1 && onlineMallMaxAmount != 0) {
                jm("#limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                jm("#limitAmountDiv").text("( " + LS.maxAmount + " : " + allowAmount + " )");
                max = allowAmount
            } else {
                if (onlineMallMinAmount > 1 && onlineMallMaxAmount == 0) {
                    jm("#limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                    jm("#limitAmountDiv").text("( " + LS.minAmount + " : " + onlineMallMinAmount + " )");
                    min = onlineMallMinAmount
                }
            }
        }
        jm("#productNum").val(min);
        jm("#productNum").unbind("change");
        jm("#productNum").change(function () {
            var countStr = jm("#productNum").val();
            var count = 1;
...
Mobi.initProductOptions = function (optionsAmountList, isRelateAmount, realMallPrice, limitAmount_options, productRestrictInfo, choiceCurrencyVal, oldOptionsStr, newOptionsStr) {
    ...
    if (oldOptionsStr != "null" && oldOptionsStr != "") {
    ...
    var optionBox = jm(".J-op-box"), optionImg = jm(".mallOptionImg"), optionlines = optionBox.find(".J-op");
    jm(optionlines).each(function (i) {
        var option = jm(this);
        option.find("label").click(function () {
            var label = jm(this);
            if (label.parent().find(".optionSelected").length > 0) {
                label.parent().find(".optionSelected").removeClass("optionSelected")
            }
            label.addClass("optionSelected");
            var item_data = label.attr("data"), optionsSelect = optionBox.find(".optionSelected");
            ...
            if (optionlines.length == optionsSelect.length) {
                ...
                jm(optionsSelect).each(function (i) {
                    if (oType2Exist) {
                ...
                jm.each(optionsAmountList, function (i, n) {
                    ...
                    if (oldOptionsStr != "null" && oldOptionsStr != "") {
                        ...
                        for (var j = 0; j < order.length; j++) {
                            for (var k = 0; k < newOptionsArr.length; k++) {
                                if (k == order[j]) {
                                    newType2Arr[k] = type2Arr[j]
                                }
                            }
                        }
                        for (var j = 0; j < newType2Arr.length; j++) {
                            if (newType2Arr[j] != null) {
                                newType2 += newType2Arr[j] + "_"
                            }
                        }
                        t2 = newType2.substring(0, newType2.length - 1)
                    }
                    if (n.t == type) {
                        price = n.oPrice;
                        amount = n.oAmount;
                    ...
                    if (oldOptionsStr != "null" && oldOptionsStr != "" && order.length != oldOptionsArr.length) {
                        amount = 0
                    }
                });
                if (limitAmount_options) {
                    ...
                    if (minAmount > 1 && maxAmount != 0) {
                        jm("#limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                        jm("#limitAmountDiv").text("( " + LS.minAmount + " : " + minAmount + " ; " + LS.maxAmount + " : " + allowAmount + " )");
                        min = minAmount;
                        max = allowAmount
                    } else {
                        if (minAmount == 1 && maxAmount != 0) {
                            ...
                            if (minAmount > 1 && maxAmount == 0) {
                                jm("#limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                                jm("#limitAmountDiv").text("( " + LS.minAmount + " : " + minAmount + " )");
                                min = minAmount
                            }
                        }
                    }
                ...
                if (isRelateAmount) {
                    jm("#mallAmount").text(amount)
                }
                if (price == null) {
                    Mobi.onlyChangeSalePrice(realMallPrice, choiceCurrencyVal)
                } else {
                    Mobi.onlyChangeSalePrice(price, choiceCurrencyVal)
                }
                if (weight != null) {
                    jm("#mallWeight").text(weight + "kg")
                }
            }
            var selectArr = [];
            ...
            var flag = false;
            if (selectArr.length <= optionlines.length && selectArr.length > 1) {
                var selectArrLen = selectArr.length;
                for (var i = 0; i < selectArrLen; i++) {
                    jm.each(optionsAmountList, function (j, n) {
                        var t2 = n.t2;
                        if (oldOptionsStr != "null" && oldOptionsStr != "") {
                            var type2Arr = n.t2.split("_"), newType2Arr = [], t2 = "", newType2 = "";
                            for (var k = 0; k < delOptionsArr.length; k++) {
                    ...
                    if (!flag) {
                        ...
                        items.removeClass("optionSelected");
            ...
            for (var j = opIndx; j < selectArr.length; j++) {
                ...
                flag = false;
                for (var i = subSelectArr.length; i < optionlines.length; i++) {
...
Mobi.waterFall = function (w, z, x, j, e, h, l) {
    ...
    if (typeof A != "object") {
        ...
        o = parseFloat(o.toFixed(4)) * 2
    } else {
        o = 0
    }
    var r = "paramWrap";
    if (l == r) {
        jm("#" + z + " .productWaterFall .paramPadding .paramName").height(o + "rem")
    } else {
        jm("#" + z + " .productWaterFall .paramPadding .paramName").height(o / 2 + "rem")
    }
    if (w.length == 1) {
        jm("#" + z + " .productWaterFall .style8Img").height(n + "rem");
        jm("#" + z + " .productWaterFall").eq(s).css({"vertical-align": "top"})
    } else {
        if (w.length == 2) {
            for (var s = 0; s < w.length; s++) {
                if (s % 2 == 0) {
                    jm("#" + z + " .productWaterFall .style8Img").eq(s).height(n + "rem");
                    jm("#" + z + " .productWaterFall").eq(s).css({"vertical-align": "top"})
                } else {
                    if (s % 2 == 1) {
                        var y = 0;
                        ...
                        if (p < d) {
                            d = d + 10 / f;
                            jm("#" + z + " .productWaterFall .firstLastPro").parent().parent().parent().parent().height(d + "rem")
                        }
                    }
                }
            }
                    ...
                    if (q + 1 == w.length) {
                        ...
                        if (w.length % 2 == 1) {
                            ...
                            if (w.length % 2 == 0) {
                                ...
                                b = (b) / f;
                                var v = (b + 0.5) * ((s + 1) / 2 - 1);
                                jm("#" + z + " .productWaterFall").eq(s).css({position: "absolute", top: v + "rem"})
                            }
                        }
                    } else {
                        jm("#" + z + " .productWaterFall .style8Img").eq(s).height(u + "rem");
...
Mobi.initProductSwipe1 = function (d) {
    ...
    c("#" + d).swipehandle(b, {
        auto: false, continuous: false, bulletsClick: true, callback: function (f) {
            var e = a.length;
            while (e--) {
                a[e].className = " "
            }
...
Mobi.productCrossedSlide = function (a, d, f, b) {
    ...
    if (b == e) {
        ...
        jm("#" + a + " .productWaterFall .paramPadding .paramName").height(l / 2 + "rem")
    }
...
Mobi.productCrossedSlideSecSwipe = function (b, l) {
    var e = Mobi.getPreviewObject(b), a = Mobi.getPreviewObject(l), k = e, o = parseInt(jm(a).width()), h = 0, c = a.querySelectorAll(".productCrossedSlideSec");
    var n = _htmlFontSize;
...
Mobi.productNewDetailEventInit = function (f) {
    ...
    var z = f.moduleId, u = f.productId, y = f.mallOptionsOpen;
    ...
    var A = document.getElementById("productDetailHeader" + z), k = document.getElementById("productNewDetailPanel" + z), q = k.querySelector(".productNewDetail .productInfoSize"), s = A.querySelector(".icon-gClose.proBack"), l = A.querySelector(".icon-noProduct.proShopping"), n = A.querySelector(".tabBody .userCommentInfo"), h = A.querySelector(".icon-gOther.proOther"), w = A.querySelector(".icon-share.proShare"), B = A.querySelector(".proOtherPanel"), a = k.querySelector(".productImmediatelyBug"), t = k.querySelector(".productMallBuy"), v = k.querySelector(".productMallShop"), p = k.querySelector("#productTabUl");
    var o = false;
    if (window.sessionStorage) {
        o = Mobi.checkWindowSeStgValue(window.sessionStorage._isJumpFromMlist);
    ...
    jm(k).bind("click", function () {
        if (jm(B).hasClass("proOtherPanelOpen")) {
            jm(B).removeClass("proOtherPanelOpen")
        }
    });
    jm(h).bind("click", function (C) {
        if (jm(B).hasClass("proOtherPanelOpen")) {
            ...
            jm(B).addClass("proOtherPanelOpen")
        }
        C.stopPropagation()
    });
    var r = Mobi.initWebPage({
    ...
    function x() {
        var D = document.getElementById("productMallOptionPanel"), E = document.getElementById("g_body").clientHeight, I = D.querySelector(".productMallOptionContentPanel"), C = D.querySelector(".productMallOptionContent"), F = D.querySelector(".productMallOptionMargin"), H = D.querySelectorAll(".productMallOptionContent>div"), G = true
    }

    var e;
    jm("#productNewDetailPanel" + z + " .productAddMall").bind("click", function () {
        r()
    });
    jm("#productNewDetailPanel" + z + " .productMallBuy").bind("click", function () {
        Mobi.mallBuy(u, e)
    });
...
Mobi.sharePage = function (l) {
    ...
    var j = jm.parseJSON(l.shareLinkList), b = l.shareUrl, d = l.browserTitle;
    var k = "", f = [];
    for (var c in j) {
        var a = j[c].url, e = j[c].icon;
...
Mobi.initPbCommUploadImgParam = function (c, d, j, k, f, h, l, b) {
    ...
    a.onload = function () {
        ...
        n.onload = function () {
            if (b == "true") {
                ...
                Mobi.mobiPbCommUploadImgHtml("comm-img-swfu-placeholder", c, d, h)
            }
        }
    };
...
Mobi.postUserComment = function (f) {
    var c = document.getElementById("userCommentPanel"), e = c.querySelector(".tabUl"), b = c.querySelector(".tabLi"), a = c.querySelector(".tabUserPanel"), d = function (n) {
        if (n) {
            var o = n.getAttribute("data"), l = c.querySelector(".tabActive").getAttribute("data"), k = document.getElementById("tabUserPanel" + o);
        ...
        jm.ajax({
            ...
            data: "cmd=loginMember&acct=" + jm.encodeUrl(o) + "&pwd=" + jm.encodeUrl(n) + "&captcha=" + jm.encodeUrl(l),
            error: function () {
...
Mobi.addTheNewComment = function (x) {
    ...
    if (x.newsId != null) {
        ...
        if (q.thumbId) {
            var p = q.width, e = q.left, n = q.top, b = q.imgW, j = q.imgH;
            var w = p / (o * 1.8);
            d.push('style="top:' + -n / w + "px; left:" + -e / w + "px; width:" + b / w + "px; height:" + j / w + 'px"')
        } else {
        ...
        if ("star" in x) {
            ...
            var k = jm(".fk-comm-avgScore"), h = Number(k.attr("_tc")) + t, l = Number(k.attr("_ts")) + 1;
            var v = h / l;
            k.text(v.toFixed(1));
            k.attr("_tc", h);
            k.attr("_ts", l)
...
Mobi.initAjaxTab = function (c) {
    ...
    var b = c.pid, f = c.moduleId, j = document.querySelector("#productDetailTabPanel" + f + " .tabUl"), d = document.querySelector("#productDetailTabPanel" + f + " .tabBody"), e = document.getElementById("productNewDetailPanel" + f), a = function (p) {
        if (!p) {
            return
        }
        var n = parseInt(p.getAttribute("data")), l = document.getElementById("tabPanel" + n), u = document.getElementById("tabLi" + n), q = e.querySelector(".tabLi.tabActive"), t = e.querySelector(".tabPanel.tabPanelAtive");
        if (!l) {
            return
        }
...
Mobi.bindCommImgShow = function (h, b, c) {
    ...
    }, j = null, d = null, f = null, e = null, a = window.Code.PhotoSwipe;
    if (b == null || !b || b == "false") {
        var k = a.attach(h, l)
    } else {
...
Mobi.scrollFadeIn = function (j, c, n) {
    var c = document.getElementById(c), j = document.getElementById(j), o = document.getElementById("g_body"), a = j.clientHeight, d = c.clientHeight, h = false, e = false;
    ...
    document.addEventListener("touchcancel", function (p) {
        l();
        b()
    }, false);
    ...
    function l() {
        ...
        if (q > d && e) {
            j.style.background = "rgba(255,255,255,0.99)";
    ...
    if (productTabUl != null && productTabUl != undefined) {
        var k = productTabUl.clientHeight, f = productTabUl.offsetTop;
...
Mobi.showSaleTimeCountDown = function (j, c, h, k, f) {
    ...
    Mobi.salePromotionDetail.saleCountTimeInterval = setInterval(function () {
        ...
        d--;
        if (k == 1) {
            jm(".showSaleTimeClass").html("&nbsp;&nbsp;" + jm.format(b, q, l, n, p))
        }
        if (d < 0) {
            if (h == 1) {
                d = c;
...
Mobi.addProductScreenFilterModel = function (f, b) {
    var a = f;
...
Mobi.initScreenFilter = function (f, h, n, j, o) {
    var c = jm.parseJSON(f);
    ...
    var k = [];
    if (c.length > 1) {
        k.push("<div class='productScreenFilterLib' id='libTab'>");
        k.push("<div class='productScreenLibLeft'>" + LS.productScreenSort + "</div>");
        k.push("<div class='g_mainColor productScreenLibRight'>");
        k.push("<div class='icon-libNextMore libNextMoreIcon'></div>");
        k.push("<div class='productScreenLibName' id='productScreenLibName'>" + d + "</div>");
        k.push("</div>");
        k.push("</div>");
        if (h) {
            var l = h.lid;
            k.push("<input type='hidden' id='lidValue' value='" + l + "'/>")
        } else {
            k.push("<input type='hidden' id='lidValue' value='-1'/>")
        }
    } else {
        k.push("<input type='hidden' id='lidValue' value='1'/>")
    }
    var p = k.join("");
    jm("#baseScreenFilterContenter").append(p);
    jm("#backContent").show();
    var a = [];
    ...
    a.push("</div>");
    p = a.join("");
    jm("#basePanel").append(p);
    if (c.length > 1) {
        Mobi.changeScreenFilterLib(f)
    }
    Mobi.initScreenFilterModel(f, h);
    Mobi.screenCommitData(f, n, j, o)
};
    ...
    jm.each(b, function (u, v) {
        if (v.lid == o) {
            ...
            for (var t = 0; t < l.length; t++) {
                Mobi.changeScreenFilterModel(t, l[t])
            }
        }
    })
};
...
Mobi.screenCommitData = function (b, a, e, d) {
    var c = jm.parseJSON(b);
    jm("#screenCommit").bind("click", function () {
        var p, k = {};
        if (c.length > 1) {
            jm.each(c, function (t, v) {
        ...
        if (p) {
            ...
            k.prop = h;
            j += r + "psc=" + jm.encodeUrl(jm.toJSON(k))
        }
        ...
        a.onclick = function () {
            if (Fai.top._onlineServiceJson.phone.phoneInfo.length > 1) {
                ...
                for (var G = 0; G < Fai.top._onlineServiceJson.phone.phoneInfo.length; G++) {
                    var L = G + 1;
                    var f = decodeURIComponent(Fai.top._onlineServiceJson.phone.phoneInfo[G].name);
                    ...
                    n.innerHTML = "<a id='numberHref_" + Fai.top._onlineServiceJson.phone.type + L + "' href='tel:" + N + "'>";
                    var y = document.getElementById("numberHref_" + Fai.top._onlineServiceJson.phone.type + L);
                    ...
                    t.appendChild(q);
                    h.appendChild(E);
                    var l = document.getElementById("phoneName" + L);
                    var b = document.getElementById("phoneNumber" + L);
                    var r = document.getElementById("phoneOperation" + L);
                ...
                var M = document.documentElement.clientHeight - k.offsetHeight;
                ...
                z.onclick = function () {
                    var O = document.getElementById("phoneDiv");
...
Mobi.initLocater = function () {
    ...
    if (!b) {
        ...
        var d = jm("#lanSelect .lanContainer").find("div[currentlan]"), a = d.length === 1 ? jm(d[0]).text() : jm(d[1]).text(), c = d.length === 1 ? jm(d[0]).attr("currentlan") : jm(d[1]).attr("currentlan");
        d.hide();
...
Mobi.mallBuy = function (e, r) {
    ...
    var p = "id=" + e + "&fromDetail=true", l = [], c = jm(".J-op"), t = true;
    jm(c).each(function () {
        var x = jm(this), u = x.attr("option_name"), w = x.attr("data"), v = x.attr("type"), j = x.attr("option_data");
        if (j) {
            var y = {};
            y.name = w;
            y.value = parseInt(j);
            if (v != null) {
                y.name = w.replace(/^opIndept/, "");
                y.type = parseInt(v)
            }
            l.push(y)
        } else {
            Mobi.ing(jm.format(LS.mallCartChoiceItemError, jm.encodeHtml(u)));
            t = false;
            return false
        }
    });
    if (Mobi.optionsStr.oldOptionsStr != "null" && Mobi.optionsStr.oldOptionsStr) {
        var q = Mobi.optionsStr.oldOptionsStr.split("_"), d = [];
    ...
    if (l.length > 0) {
        p += "&optionList=" + jm.encodeUrl(jm.toJSON(l))
    }
    var s = jm("#productNum"), b = s.val(), o = 1;
    if (jm.isInteger(b)) {
        o = parseInt(b)
    }
    if (o < 1) {
...
Mobi.mallCartAmountChange = function (a, b, h, f, j) {
    ...
    if (d < f || d == f) {
        ...
        k.find(".icon-plusIcon").removeClass("g_opacity50")
    } else {
        if ((d > j || d == j) && j != 0) {
            d = j;
            k.find(".icon-plusIcon").addClass("g_opacity50");
            k.find(".icon-minisIcon").removeClass("g_opacity50")
        } else {
            if (d > 9999998) {
                d = 9999999
            }
    ...
    c.val(d);
    if (d > 1) {
        k.find(".icon-minisIcon").removeAttr("disabled")
    } else {
        k.find(".icon-minisIcon").attr("disabled", "true")
    }
};
...
Mobi.initModuleMallAddrInfo = function (b, d, k, t) {
    var s = LS.mallPleaseChoose, y = [], n, A, r, x, B, o, z;
    if (t == 2052 || t == 1028) {
        z = site_cityUtil.getProvince();
        site_cityUtil.simpleProvinceName(z)
    } else {
    ...
    jm.each(z, function (C, D) {
        if (t == 2052 || t == 1028) {
            y.push("<option value='" + D.id + "'>" + site_cityUtil.simpleCityNameStr(D.name) + "</option>")
        } else {
            y.push("<option value='" + D.id + "'>" + site_cityUtil.simpleCityNameStrEn(D.name) + "</option>")
        }
    });
    jm("#addrInfo_province").html("").html("<option value='-1'>" + s + "</option>" + y.join("")).change(function (C) {
        n = jm("#addrInfo_province").val();
        if (isNaN(n) || n <= 0) {
        ...
        r = [];
        if (t == 2052 || t == 1028) {
            A = site_cityUtil.getCities(n);
            site_cityUtil.simpleCityName(A)
        } else {
            A = site_cityUtil.getCitiesEn(n);
            site_cityUtil.simpleCityNameEn(A)
        }
        jm.each(A, function (D, E) {
            r.push("<option value='" + E.id + "' >" + E.name + "</option>")
        });
        jm("#addrInfo_city").html("").html("<option value='-1'>" + s + "</option>" + r.join("")).unbind().bind("change", function (D) {
            x = jm("#addrInfo_city").val();
            if (isNaN(x) || x <= 0) {
                jm("#addrInfo_county").html("").html("<option value='-1'>" + s + "</option>")
            }
            ...
            o = [];
            if (t == 2052 || t == 1028) {
                B = site_cityUtil.getCounty(x)
            } else {
                B = site_cityUtil.getCountyEn(x)
            }
            jm.each(B, function (E, F) {
                o.push("<option value='" + F.id + "' >" + F.name + "</option>")
            });
            jm("#addrInfo_county").html("").html("<option value='-1'>" + s + "</option>" + o.join("")).unbind().bind("change", function (E) {
                jm("#mallShipTemplate_county").val(jm("#addrInfo_county").val());
                jm("#mallShipTemplate_county").change()
            })
        })
    });
    jm("#addrInfo_street").change(function (C) {
    ...
    jm(".addrInfo").click(function () {
        ...
        for (var E = 0; E < k.length; E++) {
            ...
            var G = D[C];
            jm(".orderSettle").find(".propItemValue").each(function () {
                if (jm(this).attr("_field") == C) {
                    jm(this).val(G)
                }
            })
        }
    });
    var j = d, w = "", l = "", f = j.length, u = "", p = false;
    ...
    jm(".edit").click(function () {
        ...
        var E = C.addr_info;
        if (E != null) {
            jm("#addrInfo_province").val(E.provinceCode);
            jm("#addrInfo_province").change();
            jm("#addrInfo_city").val(E.cityCode);
            jm("#addrInfo_city").change();
            jm("#addrInfo_county").val(E.countyCode);
            jm("#addrInfo_street").val(E.streetAddr)
        } else {
            jm("#addrInfo_street").val(C.addr)
        }
        var D = C.isDefault;
        if (D) {
            jm("#div1").attr("class", "open1");
    ...
    jm(".orderSaveAddrInfo").click(function () {
        ...
        var F = "";
        var C = false;
        K.parent().find(".propItemValue").each(function () {
            R = jm(this).attr("_field");
            G = jm(this).val();
            F = jm(this).attr("_prop");
            C = jm(this).attr("_required") == "1" ? true : false;
            if (C && (G == null || G == "")) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, F));
                this.focus();
                M = false
            }
...
Mobi.initModuleMallShipTemplate = function (h, k, r, l, o) {
    var j = r.vType || 1, c = r.sco || 0, d = r.openItemList;
    var t = LS.mallPleaseChoose, q = [], f, s, b, e, a, n, p;
    if (o == 2052 || o == 1028) {
        p = site_cityUtil.getProvince();
        site_cityUtil.simpleProvinceName(p)
    } else {
        p = site_cityUtil.getProvinceEn();
        site_cityUtil.simpleProvinceNameEn(p)
    }
    jm.each(p, function (u, v) {
        if (o == 2052 || o == 1028) {
            q.push("<option value='" + v.id + "' >" + site_cityUtil.simpleCityNameStr(v.name) + "</option>")
        } else {
            q.push("<option value='" + v.id + "' >" + site_cityUtil.simpleCityNameStrEn(v.name) + "</option>")
        }
    });
    jm("#mallShipTemplate_province").html("").html("<option value='-1'>" + t + "</option>" + q.join("")).change(function (u) {
        ...
        jm.each(s, function (v, w) {
            b.push("<option value='" + w.id + "' >" + w.name + "</option>")
        });
        jm("#mallShipTemplate_city").html("").html("<option value='-1'>" + t + "</option>" + b.join("")).unbind().bind("change", function (v) {
            Mobi.mallStlCalcTotal();
            e = jm("#mallShipTemplate_city").val();
            if (isNaN(e) || e <= 0) {
                jm("#mallShipTemplate_county").html("").html("<option value='-1'>" + t + "</option>");
                jm.each(d, function (w, x) {
            ...
            jm.each(a, function (w, x) {
                n.push("<option value='" + x.id + "' >" + x.name + "</option>")
            });
            jm("#mallShipTemplate_county").html("").html("<option value='-1'>" + t + "</option>" + n.join("")).unbind().bind("change", function (w) {
                Mobi.mallStlCalcTotal()
            });
            if (h === 0) {
                return
            ...
            jm.each(d, function (y, A) {
                ...
                jm.each(A.regionList, function (H, K) {
                    if (jm.inArray(parseInt(e), K.areaList) < 0) {
                        Mobi.changeShipTplPrice(A);
                        return true
                    }
                    var G = 0, C = K.price, I = K.rha == null ? 1 : K.rha, J = K.ria == null ? 1 : K.ria, E = K.rip || 0;
                    var F = h;
                    if (I > 0) {
                        G = C;
                        F -= I
...
Mobi.changeShipTplPrice = function (a) {
    ...
    if (jm("#shipValue")[0].offsetHeight != jm("#shipPrice")[0].offsetHeight) {
        jm(".selectship").css({lineHeight: "1.25rem"});
...
Mobi.changeShipType = function () {
    ...
    jm(".ShipItem").click(function () {
        var e = jm(this), c = parseFloat(jm("#shipPrice").attr("value")), b = parseFloat(jm("#totalValue").text()), f = parseFloat(e.find(".right").attr("value")), j = parseFloat(e.find(".right").attr("shipType")), d = e.find(".right").text(), h = e.find(".left").text();
...
Mobi.editInfoSave = function (b) {
    ...
    a.find(".propItemValue").each(function () {
        ...
        if (jm(this).attr("_required") == 1 && !x && !q) {
    ...
    if (jm(".assignItem_line").length < 1) {
        ...
        jm.each(u, function (v) {
            if ((u[v])["field"] === "name" || (u[v])["field"] === "phone") {
                c += "<span class='item_value flex1' id='info_" + (u[v])["field"] + "'>" + (u[v])["value"] + "</span>"
            } else {
                if ((u[v])["field"] === "addr") {
                    t = (u[v])["value"];
                    k = (u[v])["field"]
        ...
        if (t != "" && k != "") {
            c += "<div class='item_value flex1' id='info_" + k + "'>" + t + "</div>"
        } else {
            if (l != "") {
                c += "<div class='item_value flex1' id='info_addr'>" + l + "</div>"
            }
        }
        c += "</div>";
...
Mobi.mallSubmit = function (s, l, e, z) {
    ...
    var p = jm("#mstlBtn");
    var f = jm(".orderSettle"), B = {}, w = false, n = "";
    f.find(".propItemValue").each(function () {
        var C = jm(this), E = C.val(), F = C.attr("id");
        if (C.attr("_required") == 1 && !E && !w) {
            n = LS.mallStlSubmitInput + C.attr("_prop");
            Mobi.ing(n);
            jm("#linetitle1").click();
        ...
        if (E && E.length > 0) {
            if (D === "email" && !jm.isEmail(E)) {
                n = LS.mallStlSubmitInput2 + C.attr("_prop");
                Mobi.ing(n);
                jm("#linetitle1").click();
                document.getElementById(F).focus();
                w = true;
    ...
    if (Mobi.orderLvMessageOpen) {
        ...
        if (v.length > Mobi.orderLvMessageMaxNum) {
            v = v.substring(0, Mobi.orderLvMessageMaxNum)
        }
        B.msg = v
    } else {
        B.msg = ""
    ...
    if (jm("#mallShipTemplate_province").length == 1 && b.length == 1) {
        ...
        if (!k || isNaN(k) || !site_cityUtil.isValidProvince(k)) {
            n = LS.mallStlSubmitAddrErr;
            jm("#linetitle1").click();
            document.getElementById("mallShipTemplate_province").focus()
        } else {
            if (!r || isNaN(r) || !site_cityUtil.isValidCity(r, k)) {
                n = LS.mallStlSubmitAddrErr;
                jm("#linetitle1").click();
                document.getElementById("mallShipTemplate_city").focus()
            }
    ...
    if ((u.length == 1) && (c > 2)) {
        c = parseInt(u.attr("_paymode"));
        if (c != 9 && c != 8 && c != 7) {
            B.payBankType = parseInt(u.attr("_type"))
        }
...
Mobi.initPresentIpt = function () {
    var h = jm("#useItg");
    if (h.length > 0) {
        var a = parseInt(h.attr("_needitg"));
        var f = parseInt(h.val());
        var e = h.attr("_itegName");
        var b = parseInt(h.attr("_maxuse"));
        if (!jm.isInteger(f)) {
        ...
        if (f > parseInt(h.attr("_currentItg"))) {
...
(function (c, b, h) {
    var f = b.prototype, a, j = c(".payButton");
    f.init = function () {
        a = this.orderId;
        d()
    };
...
Mobi.moreOrderProductList = function (d, b) {
    ...
    var f = (parseInt(e.find(".line_item").eq(0).height()) + parseInt(e.find(".line_item").eq(0).css("padding-top"))) * 2, a = parseInt(e.find(".orderProductList_inner").eq(0).height());
    if (c.attr("type") == "0") {
        e.css("height", a + "px");
        c.attr("type", "1");
        if (c.attr("is_cn") == "0") {
...
Mobi.initOrderCancelButton = function (b) {
    ...
    a.find(".J-orderCancel").click(function () {
        ...
        var f = {
            textClass: "deleteOrder", content: LS.orderCancelMsg, callback: function () {
                c(e, d)
            }
        };
        Mobi.prompt(f)
...
Mobi.initCommentBtn = function (d, a) {
    ...
    _initItemCommentPanel = function (p, x, h, s, u) {
        var t = h.attr("_iprice"), A = h.attr("_iname"), q = h.attr("_ipath"), B = h.attr("_maxlen"), r = h.attr("_minlen"), n = h.attr("_showflag"), f = h.attr("_comment"), y = h.attr("_pathList"), C = h.attr("_star");
    ...
    var j = {
        ...
        onUploadSuccess: function (o, q) {
            ...
            if (p.success) {
                ...
                Mobi.onCommFileUploadEvent("upload", p, k)
            } else {
...
Mobi.initNewsEvent = function (b, j) {
    if (!b) {
        return
    }
    var e = document.getElementById("productDetailHeader" + b), a = document.getElementById("newsDetailShare"), d = e.querySelector(".icon-gClose");
    var f = {
    ...
    var c = navigator.userAgent.toLowerCase();
    if (jm.os.ios) {
        var k = (navigator.appVersion).match(/OS (\d+)_(\d+)_?(\d+)?/);
        k = k ? [parseInt(k[1], 10), parseInt(k[2], 10), parseInt(k[3] || 0, 10)] : [0, 0];
        if (Number(k[0]) > 5) {
            Mobi.setNewDetailPanelHeight()
        }
    }
    Mobi.hidePlaceholder()
};
...
var site_cityUtil = (function () {
    ...
    var j = function (y) {
        ...
        if (!h) {
            ...
            jm.each(u, function (B, A) {
                ...
                C.id = B;
                h.push(C);
                if (w && jm.inArray(parseInt(B), w) >= 0) {
                    x.push(C)
                }
            });
            if (!w || w.length <= 0) {
        ...
        jm.each(h, function (B, A) {
            if (w && jm.inArray(parseInt(A.id), w) >= 0) {
                x.push(A)
            }
        });
        return x
    ...
    var a = function (w) {
        ...
        if (w.slice(w.length - 29, w.length) == "Special Administrative Region") {
            w = w.slice(0, w.length - 30)
        }
        if (w.slice(w.length - 17, w.length) == "Autonomous Region") {
            w = w.slice(0, w.length - 18)
        }
        if (w.slice(w.length - 8, w.length) == "Province" || w.slice(w.length - 8, w.length) == "province") {
            w = w.slice(0, w.length - 9)
        }
        if (w.slice(w.length - 6, w.length) == "Zhuang") {
            w = w.slice(0, w.length - 7)
        }
        if (w.slice(w.length - 5, w.length) == "Uygur") {
            w = w.slice(0, w.length - 6)
        }
        if (w.slice(w.length - 3, w.length) == "Hui") {
    ...
    var r = function (w) {
        ...
        if (w.slice(w.length - 29, w.length) == "Tibetan Autonomous Prefecture") {
            w = w.slice(0, w.length - 30)
        }
        if (w.slice(w.length - 22, w.length) == "Li and Miao Autonomous") {
            w = w.slice(0, w.length - 23)
        }
        if (w.slice(w.length - 13, w.length) == "Li Autonomous") {
            w = w.slice(0, w.length - 14)
        }
        if (w.slice(w.length - 10, w.length) == "Prefecture") {
            w = w.slice(0, w.length - 11)
        }
        if (w.slice(w.length - 9, w.length) == "Mongolian") {
            w = w.slice(0, w.length - 10)
        }
        if (w.slice(w.length - 6, w.length) == "County") {
            w = w.slice(0, w.length - 7)
        }
        if (w.slice(w.length - 4, w.length) == "City") {
            w = w.slice(0, w.length - 5)
        }
        return w
    };
    return {
        getAreaGroups: function () {
            return s
        }, getProvince: function (w) {
            return j(w)
        }, getCities: function (w) {
            return v(w)
        }, getCounty: function (w) {
            return v(w)
        }, getInfo: function (w) {
            return q(w)
        }, simpleProvinceName: function (w) {
            jm.each(w, function (x, y) {
                w[x].name = e(w[x].name)
            })
        }, simpleProvinceNameStr: function (w) {
            return e(w)
        }, simpleCityName: function (w) {
            jm.each(w, function (x, y) {
                w[x].name = b(w[x].name)
            })
        }, simpleCityNameStr: function (w) {
            return b(w)
        }, simpleProvinceNameEn: function (w) {
            jm.each(w, function (x, y) {
                w[x].name = a(w[x].name)
            })
        }, simpleCityNameEn: function (w) {
            jm.each(w, function (x, y) {
                w[x].name = r(w[x].name)
            })
        }, simpleCityNameStrEn: function (w) {
            return r(w)
        }, simpleProvinceNameStrEn: function (w) {
            return a(w)
        }, getProvinceEn: function (w) {
            return o(w)
        }, getCitiesEn: function (w) {
            return t(w)
        }, getCountyEn: function (w) {
            return t(w)
        }, getInfoEn: function (w) {
            return d(w)
        }, simpleCityListStr: function (A) {
            if (!A || A.length <= 0) {
                return "未添加地区"
            }
            var y = {};
            ...
            var w = z.join("") + x.join("");
            return w.slice(0, w.length - 1)
        }, isValidProvince: function (w) {
            return n(w)
        }, isValidCity: function (x, w) {
            return p(x, w)
        }
    }
}());
...
Mobi.logoSizeCompressByMargin = function () {
    var l = jm("#pageLogo"), j = jm("#webHeader");
    if (j.css("display") == "none") {
        return
    }
    l.height(0);
    var b = parseFloat(l.css("margin-top").replace("px", "")), f = parseFloat(l.css("margin-bottom").replace("px", "")), h = parseFloat(l.height()), a = parseInt(l.attr("sid")), k = parseInt(l.attr("pw")), d = parseInt(l.attr("ph")), c = parseFloat(j.height()), e = 0;
    e = Math.floor(c - b - f);
    l.height(e + "px");
    if (a != 0) {
        l.width(parseInt(l.height()) + "px")
    } else {
        l.width(parseInt(l.height()) * k / d + "px")
    }
};
Mobi.titlePositionRefreshByLogo = function () {
    var e = jm("#pageLogo"), d = jm("#header"), f = jm("#pageTitle"), a = jm("#webHeader");
    ...
    if (e.css("display") != "none") {
        ...
        if (d.css("text-align") == "center" && (e.hasClass("left") || e.hasClass("right"))) {
            e.css({position: "absolute", "float": "none"});
            d.css("padding", 0);
            if (e.hasClass("left")) {
...
Mobi.iframeToEmbed = function (b, f, a) {
    ...
    if (jm.os.ie) {
        if (a == "v.youku.com" || a == "player.youku.com") {
            c = "/player.youku.com/player.php/sid/" + f + "/v.swf"
        } else {
            if (a == "v.qq.com" || a == "static.video.qq.com") {
                c = "/static.video.qq.com/TPout.swf?vid=" + f + "&auto=0"
            } else {
                return false
            }
        }
...
Mobi.scrollBgmPosition = function () {
    var e = jm("#bgMusic .bgm_icon"), f = jm("#webMultilingualArea"), d = jm("#webHeaderBox"), j = jm(".loginHeader.webHeaderBg"), a = parseInt(d.height());
    ...
    if (e.hasClass("bgm_rightUp") || e.hasClass("bgm_leftUp")) {
        ...
        if (!h) {
            if (j.length > 0) {
                h = j.offset().top + parseInt(j.height()) - c + 10
            }
            h = h > 0 ? h : 10;
            e.css("top", h + "px");
            return
...
Mobi.initBannerDefaultDom = function (q) {
    ...
    var b = q.et, n = q.b, r = n.length, f, e;
    var h = [];
    ...
    for (e = 0; e < r; e++) {
        if (e == 0) {
            h.push("<li class='on' " + (r == 1 ? "style='display:none;'" : "") + "></li>")
        } else {
            h.push("<li></li>")
        }
    }
...
Mobi.initSwipe = function (a, n, f) {
    ...
    var d = s.querySelectorAll(".bannerImageDiv.customBanner"), u = s.querySelectorAll(".bannerImageDiv"), v = d.length, h = u.length, j = s.offsetWidth, c = "", o = 0, p, w, x;
    for (var t = 0; t < v; t++) {
    ...
    if (h === 0) {
        s.querySelector(".defaultBanner").style.height = Math.ceil(j * 300 / 640) + "px"
    } else {
        c = h - v > 0 ? (j * o < j * 300 / 640 ? Math.ceil(j * 300 / 640) : Math.ceil(j * o)) : Math.ceil(j * o);
        s.style.height = c + "px"
    }
    if (!f) {
        if (!Mobi.checkBrowser() || Fai.top._bannerData.et == 1) {
            ...
            var k = s.getBoundingClientRect().width, b = s.children[0], r = b.children;
            var l = r.length;
            while (l--) {
                r[l].style.width = k + "px"
            }
        }
...
Mobi.bannerAnimate = {};
(function (n, N, o) {
    var f = false, T = 1, j = 0, X = -1, G = -1, u = false, P = true, D, h = 0, Q = {duration: 3000}, W = {}, E = 0, c = 0, R, U = n("#bannerSwipe"), H = U.find(".bannerSwipeContainer"), w = H.find(".billboard_item"), h = w.length;
    N.init = function (Z) {
        var Y = Z;
        if (Y.showType == 3) {
            return
        }
        var aa = Mobi.checkBrowser();
        if (!aa || Y.et == 1) {
            return false
        }
        clearTimeout(D);
    ...
    function F(Y) {
        ...
        h = w.length;
        var Z = n("#bullets"), aa = Z.find("li");
        aa.removeClass("on");
        aa.eq(j).addClass("on")
    }

    function I(ao) {
        var an = T, aa = ao.w, am = ao.h, al = ao.b, ak = al.length, ap = 0, aj, ai, ad, ab;
        switch (an) {
            case 9:
            case 10:
                ap = 4;
        ...
        var ac = [];
        ac.push("<div id='bannerSwipe' class='swipe'>");
        ac.push("<div id='bannerSwipeContainer' class='bannerSwipeContainer defaultBanner billboard billboard" + an + "'>");
        var ah, ae, aq, Z, ag, Y, af, aq, ad, ab;
        for (aj = 0; aj < ak; aj++) {
            ah = al[aj].i;
            ae = al[aj].lt;
            aq = "";
            ...
            ab = 1;
            if (ap == 0) {
                ac.push("<div id='bannerItem" + ah + "' class='billboardAnim billboard_item " + (ap != 0 ? "billboard_item" + aj : "") + "  billboardItem_" + an + "' >");
                ac.push("<a href='" + (ae != 0 ? aq : "javascript:;") + "' vheight='" + ag + "' vwidth='" + Z + "' class='bannerImageDiv " + (Y == 0 ? "systemtBanner" : "customBanner") + "' style='display:block; background-image:url(" + af + ");'></a>")
            } else {
                if (ap == 4) {
                    ac.push("<div class='billboard_item billboardItem_" + an + " billboardItem_" + an + "_" + (aj + 1) + "'>");
                    for (ab = 1; ab < ap; ab++) {
                        ac.push("<div class='billboardTile billboardTile_" + ab + " billboardAnim'>");
                        ac.push("<div class='billboardImg'>");
                        ac.push("<a class='bannerImageDiv J_bannerItem systemtBanner billboardImgInner " + (Y == 0 ? "systemtBanner" : "customBanner") + "' hidefocus='true' title='' href='" + (ae != 0 ? aq : "javascript:;") + "' vheight='" + ag + "' vwidth='" + Z + "' target='' style='overflow: hidden; display: block; outline: none; margin: 0px auto; position: relative; z-index: 1; background-image: url(" + af + "); background-position: 50% 50%; background-repeat: no-repeat;'>");
                        ac.push("</a>");
                        ac.push("</div>");
                        ac.push("</div>")
                    }
                    ...
                    ac.push("<div class='billboard_item billboardItem_" + an + " billboardItem_" + an + "_" + (aj + 1) + "'>");
                    for (ad = 1; ad < ap; ad++) {
                        ac.push("<div class='billboardTile billboardTile_" + ad + "'>");
                        ac.push("<div class='billboardAnim billboardTileImg'>");
                        ac.push("<div class='billboardImg'>");
                        ac.push("<a class='bannerImageDiv J_bannerItem systemtBanner billboardImgInner " + (Y == 0 ? "systemtBanner" : "customBanner") + "' hidefocus='true' title='' href='" + (ae != 0 ? aq : "javascript:;") + "' vheight='" + ag + "' vwidth='" + Z + "' target='' style='overflow: hidden; display: block; outline: none; margin: 0px auto; position: relative; z-index: 1; background-image: url(" + af + "); background-position: 50% 50%; background-repeat: no-repeat;'>");
                        ac.push("</a>");
                        ac.push("</div>");
        ...
        ac.push("</div>");
        ac.push("<div id='bannerBullet' class='bannerBullet' style='" + (ak < 2 ? "display:none;" : "") + "' >");
        ac.push("<ul id='bullets' class='bullets'>");
        for (ai = 0; ai < ak; ai++) {
            if (ai == j) {
                ac.push("<li class='on'></li>")
            } else {
                ac.push("<li></li>")
            }
        }
    ...
    function b() {
        ...
        var Z = w.eq(j);
        Z.addClass("billboardItem_" + T + "_start");
        var aa, ab;
        if (W.effectIndex == 0) {
        ...
        for (var Y = 0; Y < w.length; Y++) {
            aa = w.eq(Y);
            z(aa, "animationDuration", W.switchingTime + "ms");
            ab = aa.find(".billboardAnim");
            switch (T) {
                case 3:
                    z(aa, "transformOrigin", "50% 50% " + (-E / 2) + "px");
                    break;
                case 4:
                    z(aa, "transformOrigin", "50% 50% " + (-c / 2) + "px");
                    break;
                case 9:
                    ...
                    break;
                case 10:
                    z(ab, "transformOrigin", "50% 50% " + (-aa.find(".billboardAnim").height() / 2) + "px");
                    z(ab, "animationDuration", W.switchingTime + "ms");
                    aa.css("height", itemMaxHeight1);
                    break;
                case 11:
                case 12:
                case 13:
    ...
    function t() {
        var Y = n("#bannerBullet"), Z = Y.find("li");
        Z.click(function (ab) {
            ab.stopPropagation();
            var aa = Z.index(this);
            g = aa;
    ...
    function x(Z) {
        var Y = n("#bullets"), aa = Y.find("li");
        aa.removeClass("on");
        aa.eq(Z).addClass("on")
    }

    function p(aa, ab) {
        var Z = w.eq(j), Y = w.eq(aa);
        Y.css("display", "block");
        Z.removeClass("billboardItem_" + T + "_on billboardItem_" + T + "_on_reverse").addClass("billboardItem_" + T + "_off");
        Y.removeClass("billboardItem_" + T + "_off billboardItem_" + T + "_off_reverse").addClass("billboardItem_" + T + "_on");
        if (ab) {
            Z.addClass("billboardItem_" + T + "_off_reverse");
            Y.addClass("billboardItem_" + T + "_on_reverse")
        }
    }

    function S(Z, aa) {
        if (isNaN(Z) || Z >= h || Z < 0 || Z == j) {
            return
        }
        if (u) {
            return
    ...
    function J(Y, Z) {
        Y.addEventListener("animationend", Z, false);
        Y.addEventListener("webkitAnimationEnd", Z, false);
        Y.addEventListener("oAnimationEnd", Z, false);
        Y.addEventListener("oanimationend", Z, false);
        Y.addEventListener("msAnimationEnd", Z, false);
        return true
    }

    function q(Y, Z) {
        Y.removeEventListener("animationend", Z, false);
        Y.removeEventListener("webkitAnimationEnd", Z, false);
        Y.removeEventListener("oAnimationEnd", Z, false);
        Y.removeEventListener("oanimationend", Z, false);
        Y.removeEventListener("msAnimationEnd", Z, false);
        return true
    }
    ...
    function K(Y) {
        var Z = Y.targetTouches[0];
        a = 0;
        d = {x: Z.pageX, y: Z.pageY, time: +new Date};
        H[0].addEventListener("touchmove", l, false);
        H[0].addEventListener("touchend", v, false)
    }

    function l(Y) {
        if (Y.targetTouches.length > 1 || Y.scale && Y.scale !== 1) {
            return
        }
        var Z = Y.targetTouches[0];
        r = {x: Z.pageX - d.x, y: Z.pageY - d.y, time: +new Date};
    ...
    function z(aa, ab, Z) {
        var Y = ab.substring(0, 1).toUpperCase() + ab.substring(1);
        aa.css("Webkit" + Y, Z);
        aa.css("Moz" + Y, Z);
        aa.css("ms" + Y, Z);
        aa.css("O" + Y, Z);
    ...
    function y(ab, Z) {
        var aa = Z - ab + 1, Y = 0;
        while (Y == 0) {
            Y = Math.floor(Math.random() * aa + ab)
        }
        return Y
    }
})(jm, Mobi.bannerAnimate);
Mobi.initTemplate2 = function (f) {
    var e = Mobi.getJQMobi(), a = f.layout, h = f.moduleStyle, d = f.designType, c = Mobi.getPreviewObject("navbar"), b = Mobi.getPreviewObject("navbarList");
    if (c) {
...
Mobi.changeMorePosition = function (d) {
    ...
    if (d === 1) {
        for (var b = 0; b < a; b++) {
            var h = e[b], c = h.querySelector(".formBannerMore");
            if (!c) {
                continue
            }
            h.appendChild(c)
        ...
        for (var b = 0; b < a; b++) {
            var h = e[b], f = h.querySelector(".formBannerTitle>.titleCenter"), c = h.querySelector(".formBannerMore");
            f.appendChild(c)
        }
    }
};
Mobi.scrollNavFix = function () {
    var d = document.getElementById("navbar"), e = document.getElementById("g_body"), c = d.clientHeight, b = false, f = d.offsetTop;
...
Mobi.autoSetNavBarHeight = function (a) {
    var f = Mobi.getPreviewObject("webHeader").offsetHeight, d = Mobi.getPreviewObject("webTips") ? Mobi.getPreviewObject("webTips").offsetHeight : 0, c = 0, e = 4 + parseInt(jm(Mobi.getPreviewObject("navbar")).css("bottom").replace("px", ""));
    if (jm.os.iphone) {
        if (a == 4) {
...
Mobi.fixImageHeight = function (d) {
    ...
    var e = c.querySelectorAll("img"), a = 1;
    initHeight = 0;
    for (var b = 0; b < e.length; b++) {
        (function (h) {
            var k = new Image();
            ...
            if (a % 2 === 0 || h === e.length - 1) {
                if (initHeight > 0 && initHeight < 160) {
                    if (a % 2 === 1 && h === e.length - 1) {
                        e[h].parentNode.style.height = (initHeight / _htmlFontSize) + "rem"
                    }
                    if (a % 2 === 0) {
                        for (var f = 0; f < 2; f++) {
                            e[h + f - 1].parentNode.style.height = (initHeight / _htmlFontSize) + "rem"
                        }
                    }
                }
                initHeight = 0
